...
namespace silkroadmvc.Data
{
    public static class SeedData
    {
        ...
        private static void SeedAuction(ApplicationDbContext context)
        {
        ...
        private static void SeedAuctionType(ApplicationDbContext context)
        {
        ...
        private static void SeedAuctionStatus(ApplicationDbContext context)
        {
        ...
        public static void SeedClientData(ApplicationDbContext context)
        {
        ...
        private static void SeedBidData(ApplicationDbContext context)
        {
            if (context.Bids.Any())
            {
                return;   // DB has been seeded
